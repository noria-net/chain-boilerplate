...
[![Go Report Card](https://goreportcard.com/badge/github.com/noria-net/chain-boilerplate)](https://goreportcard.com/report/github.com/noria-net/chain-boilerplate)
[![license](https://img.shields.io/github/license/CosmWasm/wasmd.svg)](https://github.com/noria-net/chain-boilerplate/blob/main/LICENSE)
[![LoC](https://tokei.rs/b1/github/CosmWasm/wasmd)](https://github.com/noria-net/chain-boilerplate)
<!-- [![GolangCI](https://golangci.com/badges/github.com/noria-net/chain-boilerplate.svg)](https://golangci.com/r/github.com/noria-net/chain-boilerplate) -->
...
make test
```
if you are using a linux without X or headless linux, look at [this article](https://ahelpme.com/linux/dbusexception-could-not-get-owner-of-name-org-freedesktop-secrets-no-such-name) or [#31](https://github.com/noria-net/chain-boilerplate/issues/31#issuecomment-577058321).
...
* `-X github.com/noria-net/chain-boilerplate/app.NodeDir=.corald` - set the config/data directory for the node (default `~/.wasmd`)
* `-X github.com/noria-net/chain-boilerplate/app.Bech32Prefix=coral` - set the bech32 prefix for all accounts (default `wasm`)
* `-X github.com/noria-net/chain-boilerplate/app.ProposalsEnabled=true` - enable all x/wasm governance proposals (default `false`)
* `-X github.com/noria-net/chain-boilerplate/app.EnableSpecificProposals=MigrateContract,UpdateAdmin,ClearAdmin` - 
